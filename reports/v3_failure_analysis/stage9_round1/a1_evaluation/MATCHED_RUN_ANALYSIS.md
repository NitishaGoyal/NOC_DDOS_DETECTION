...
### Conv1D-GCN
- Target `N-3-7-8-12-Pmixed-R18-V3`: median probability 0.9988, error rate 98.48%, longest error streak 3096.
- Control `N-1-6-9-14-Pmixed-R17-V3`: median probability 0.2295, error rate 22.35%, longest error streak 27.
...
### Conv1D-GCN
- Target `N-5-10-Pbursty-R51-A-12-S20-V3`: median probability 0.7340, error rate 25.81%, longest error streak 21.
- Control `N-2-13-Pstream-R50-A-12-S20-V3`: median probability 0.9409, error rate 8.75%, longest error streak 27.
- Control `N-1-6-9-14-Pmixed-R52-A-12-S20-V3`: median probability 0.7897, error rate 18.77%, longest error streak 9.
...
- The hard normal run has a mean four-model error rate of **87.1%** at threshold 0.50, versus **18.6%** for the exact mixed/four-core test control.
- Its middle-80% mean error rate is **89.9%**, so the failure is not confined to run startup or shutdown.
- The hard attack has a mean four-model error rate of **53.1%** and a middle-80% mean error rate of **54.2%**.
- All four models are simultaneously wrong on **64.0%** of hard-normal windows and **10.0%** of hard-attack windows at threshold 0.50.
- Model predictions disagree on **35.5%** of hard-normal windows and **79.6%** of hard-attack windows.
