...
"
        f"- Selected full architecture: **Causal Depthwise-Separable Conv1D Temporal Encoder + Two-Layer GraphConv**
"
        f"- Temporal frontend reference: **B3**
"
        f"- Paper short name: **Temporal Conv1D-GraphConv**
"
        f"- Selected seed: **107**
"
        f"- Selected epoch: **25**
"
        f"- Checkpoint SHA-256: `82314baedb4bf3969842abf9076679682369daae2e57db07d4b4aeaa8623f7cc`
