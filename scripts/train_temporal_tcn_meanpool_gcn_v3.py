...
class TemporalTCNEncoder(nn.Module):
    """
    TCN temporal encoder with mean pooling instead of attention pooling.
    ...
    def forward(self, x):
        ...
        # Mean pooling over time instead of attention pooling
        h = h.mean(dim=-1)  # [B*N, temporal_dim]
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if improvement > args.min_delta:
            ...
            checkpoint = {
                ...
                "model_name": "TCN-MeanPool-TemporalGCN",
            }
    ...
    print("\nFINAL")
    print("model:", "TCN-MeanPool-TemporalGCN")
    ...
    summary = {
        "model": "TCN-MeanPool-TemporalGCN",
        "data": args.data,
