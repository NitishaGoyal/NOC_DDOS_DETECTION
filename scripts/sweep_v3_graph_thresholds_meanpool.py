...
import train_temporal_tcn_meanpool_gcn_v3 as mpmod
...
def main():
    ...
    lines = []
    lines.append("V3 MeanPool graph-threshold sweep")
    lines.append("=" * 100)
    ...
    for split_name, idx in [("VAL", val_idx), ("TEST", test_idx)]:
        ...
        lines.extend(sweep_one(f"{split_name} TCN-MeanPool-GCN", pred))
