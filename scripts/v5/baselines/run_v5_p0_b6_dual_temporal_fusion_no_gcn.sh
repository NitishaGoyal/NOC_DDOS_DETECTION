...
SCRIPT="$REPO/scripts/v5/baselines/train_v5_p0_b6_dual_temporal_fusion_no_gcn.py"
OUT="$REPO/reports/v5/p0_b6_dual_temporal_fusion_no_gcn"
MODEL_DIR="$REPO/models/v5/p0_b6_dual_temporal_fusion_no_gcn"
LOG="$REPO/logs/v5/v5_p0_b6_dual_temporal_fusion_no_gcn.log"

echo "===== V5 P0-B6 DUAL TEMPORAL FUSION, NO GCN ====="
echo "repo=$REPO"
echo "data=$DATA"
echo "a2=$A2"
echo "a2_1=$A2_1"
...
echo
echo "v5_p0_b6_status=$status"

if [ -f "$OUT/V5_P0_B6_DUAL_TEMPORAL_FUSION_NO_GCN_COMPLETE" ]; then
    cat "$OUT/V5_P0_B6_DUAL_TEMPORAL_FUSION_NO_GCN_COMPLETE"
elif [ -f "$OUT/V5_P0_B6_DUAL_TEMPORAL_FUSION_NO_GCN_HOLD" ]; then
    cat "$OUT/V5_P0_B6_DUAL_TEMPORAL_FUSION_NO_GCN_HOLD"
else
