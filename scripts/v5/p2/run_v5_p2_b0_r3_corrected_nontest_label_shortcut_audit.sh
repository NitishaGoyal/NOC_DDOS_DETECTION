...
SCRIPT="$REPO/scripts/v5/p2/audit_v5_p2_b0_r3_corrected_nontest_label_shortcuts.py"

OUT="$REPO/reports/v5/p2_b0_r3_corrected_nontest_label_shortcut_audit"
LOG="$REPO/logs/v5/v5_p2_b0_r3_corrected_nontest_label_shortcut_audit.log"

echo "===== V5 P2-B0-R3 CORRECTED NON-TEST LABEL + SHORTCUT AUDIT ====="
echo "repo=$REPO"
echo "data=$DATA"
echo "a0=$A0"
echo "a1_r2=$A1_R2"
...
echo "b0_r2=$B0_R2"
echo "loader=$LOADER"
echo "corrected_model=$MODEL"
echo "script=$SCRIPT"
echo "output=$OUT"
echo "log=$LOG"
echo "count_categories=K1_K2_K3_K4"
echo "count_head_logits=4"
echo "role_mask_semantics=source_plus_2transit_plus_4victim"
...
echo
echo "v5_p2_b0_r3_status=$status"

if [ -f "$OUT/V5_P2_B0_R3_CORRECTED_NONTEST_LABEL_AND_SHORTCUT_AUDIT_COMPLETE" ]; then
    cat "$OUT/V5_P2_B0_R3_CORRECTED_NONTEST_LABEL_AND_SHORTCUT_AUDIT_COMPLETE"
elif [ -f "$OUT/V5_P2_B0_R3_CORRECTED_NONTEST_LABEL_AND_SHORTCUT_AUDIT_HOLD" ]; then
    cat "$OUT/V5_P2_B0_R3_CORRECTED_NONTEST_LABEL_AND_SHORTCUT_AUDIT_HOLD"
else
