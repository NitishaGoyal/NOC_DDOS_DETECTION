...
STAGE = "V5_P3_F7_E2_GENERATED_TRAINER_STATIC_AND_RUNTIME_PREFLIGHT"
...
def main() -> int:
    ...
    scratch = output_dir / "F7_E2_RUNTIME_PREFLIGHT_SCRATCH"
    if scratch.exists():
    ...
    static_path = output_dir / (
        "F7_E2_GENERATED_TRAINER_STATIC_CERTIFICATION.json"
    )
    runtime_path = output_dir / (
        "F7_E2_RUNTIME_ADAPTER_AND_FIRST_BATCH_CERTIFICATION.json"
    )
    decision_path = output_dir / (
        "F7_E2_PRIMARY_MATRIX_EXECUTION_DECISION.json"
    )
