...
STAGE = "V5_P3_F7_E2_R6_RECURSIVE_BATCH_DEVICE_TRANSFER_RECOVERY"
...
def main() -> int:
    ...
    legacy_guard_corrected_trainer_path = (
        ...
        / "run_v5_p3_f7_reconstructed_group_ablation_trainer_e2_r6_legacy_guards.py"
    )
    ...
    item_batch_trainer_path = (
        original_trainer_path.parent
        / "run_v5_p3_f7_reconstructed_group_ablation_trainer_e2_r6_item_batch.py"
    )
    ...
    corrected_trainer_path = (
        original_trainer_path.parent
        / "run_v5_p3_f7_reconstructed_group_ablation_trainer_e2_r6.py"
    )
    ...
    corrected_launcher_path = (
        ...
        / "run_v5_p3_f7_primary_seed107_matrix_e2_r6.sh"
    )
    require(
        "shlex" in globals(),
    ...
    scratch = output_dir / "F7_E2_R6_RUNTIME_PREFLIGHT_SCRATCH"
    if scratch.exists():
    ...
    static_results = {
        "recovery_classification": (
            "P3_default_collate_preserved_non_tensor_metadata_as_list_but_legacy_P2_move_batch_called_to_on_every_top_level_value"
        ),
    ...
    launcher_patch_path = output_dir / (
        "F7_E2_R6_CORRECTED_MATRIX_LAUNCHER_PATCH.json"
    )
    atomic_json(launcher_patch_path, launcher_patch)

    static_path = output_dir / (
        "F7_E2_R6_GENERATED_TRAINER_STATIC_CERTIFICATION.json"
    )
    runtime_path = output_dir / (
        "F7_E2_R6_RUNTIME_ADAPTER_AND_FIRST_BATCH_CERTIFICATION.json"
    )
    decision_path = output_dir / (
        "F7_E2_R6_PRIMARY_MATRIX_EXECUTION_DECISION.json"
    )
