...
STAGE = "V5_P3_F7_E2_R1_CANONICAL_STATE_HASH_RECOVERY"
...
def main() -> int:
    ...
    scratch = output_dir / "F7_E2_R1_RUNTIME_PREFLIGHT_SCRATCH"
    if scratch.exists():
    ...
    static_path = output_dir / (
        "F7_E2_R1_GENERATED_TRAINER_STATIC_CERTIFICATION.json"
    )
    runtime_path = output_dir / (
        "F7_E2_R1_RUNTIME_ADAPTER_AND_FIRST_BATCH_CERTIFICATION.json"
    )
    decision_path = output_dir / (
        "F7_E2_R1_PRIMARY_MATRIX_EXECUTION_DECISION.json"
    )
