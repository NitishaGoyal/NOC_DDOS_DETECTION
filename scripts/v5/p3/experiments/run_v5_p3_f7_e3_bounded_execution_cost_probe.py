...
STAGE = "V5_P3_F7_E3_BOUNDED_EXECUTION_COST_PROBE"
...
def main() -> int:
    ...
    scratch = output_dir / "F7_E3_BOUNDED_EXECUTION_COST_PROBE_SCRATCH"
    require(
        not scratch.exists(),
    ...
    probe_trainer = scratch / (
        "run_v5_p3_f7_e3_bounded_cost_probe_trainer.py"
    )
    ...
    probe_json = run_dir / "F7_E3_BOUNDED_COST_PROBE_RESULT.json"
