...
from samplers.chrono_b1_scenario_sampler import ScenarioBalancedBatchSampler
...
def main():
    ...
    parser.add_argument("--b1-samples-per-epoch", type=int, default=148185)
    parser.add_argument("--b1-max-temporal-retries", type=int, default=32)
    ...
    summary = {
        ...
        "sampling": {
            ...
            "samples_per_epoch": int(args.b1_samples_per_epoch),
            "replacement": True,
            "normal_probability": 0.5,
            "attack_probability": 0.5,
            "temporal_window_length": int(x_shape[2]),
            "max_temporal_retries": int(args.b1_max_temporal_retries),
            "final_epoch_stats": train_batch_sampler.last_epoch_stats(),
        },
        "training": {
